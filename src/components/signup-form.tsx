  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        ...
        <Field>
          <FieldLabel className="text-[#ffe26e]" htmlFor="name">
            Full Name
          </FieldLabel>
          <Input
            className="bg-white"
        ...
        <Field>
          <FieldLabel className="text-[#ffe26e]" htmlFor="email">
            Email
          </FieldLabel>
          <Input
            className="bg-white"
        ...
        <Field>
          <FieldLabel className="text-[#ffe26e]" htmlFor="password">
            Password
          </FieldLabel>
        ...
        <Field>
          <FieldLabel className="text-[#ffe26e]" htmlFor="confirm-password">
            Confirm Password
          </FieldLabel>
          <Input
            className="bg-white"
