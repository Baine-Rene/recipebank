import { Circle, CircleDot, CircleIcon, GalleryVerticalEnd, GaugeCircleIcon, LucideCircleDot, PlayCircle } from "lucide-react"

import { LoginForm } from "@/components/login-form"

export default function LoginPage() {
  return (
    <div className="grid min-h-svh lg:grid-cols-2 bg-[#594b3c]">
